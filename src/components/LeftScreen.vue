...
export default {
  ...
  methods: {
    ...
    async load_info() {
      try {
        this.isLoading = true;
        let response = await axios.get(`/active_orders`, {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
          },
        });
        this.active_orders = response.data.orders;
        let numbers_orders = Object.keys(this.active_orders);
        this.orders = Object.values(this.active_orders);
